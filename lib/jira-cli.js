(function() {
  ...
  JiraHelper = (function() {
    ...
    JiraHelper.prototype.getFixVersions = function(project, callback) {
      var _this = this;
      return this.jira.getVersions(project, function(error, response) {
        if (response != null) {
          return callback(response);
        } else {
          _this.log.error("Error listing issueTypes: " + error);
    ...
    JiraHelper.prototype.createIssueObject = function(project, summary, issueType, description, fixVersion) {
    ...
    JiraHelper.prototype.addIssue = function(summary, description, fixVersion, issueType, project) {
      var newIssue,
        _this = this;
      newIssue = this.createIssueObject(project, summary, issueType, description, fixVersion);
